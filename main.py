...
class PushBlock:
    ...
    def animation(self):
        ...
        gfxdraw.rectangle(screen, (self.body.position[0] - 10, self.body.position[1], 20, 2000 - self.body.position[1]),
    ...
    def animation(self):
        ...
        if self.body.velocity.length > 400:
            gfxdraw.rectangle(screen, (self.body.position[0] + randint(50, 100) * sin(pangle),
                                       self.body.position[1] + randint(50, 100) * cos(pangle), 10, 10),
                              (0, randint(0, 255), randint(0, 255)))
            gfxdraw.box(screen, (self.body.position[0] + randint(25, 100) * sin(pangle),
                                 self.body.position[1] + randint(25, 100) * cos(pangle), 10, 10),
                        (0, randint(0, 255), randint(0, 255)))
...
class IceRectangle:
    ...
    def animation(self):
        ...
        gfxdraw.polygon(screen, [self.body.position, (500, 1200), (540, 1200), (580, 1200)],
                        (0, randint(0, 255), randint(0, 255)))
        screen.blit(n, (self.body.position[0] - n.get_width() // 2, self.body.position[1] - n.get_height() // 2))
...
while True:
    ...
    for ev in fastevent.get():
        ...
        push_block_right.check_movenment(xd > 540, ev.type == FINGERDOWN or ev.type == FINGERMOTION,
                                         ev.type == FINGERUP)
